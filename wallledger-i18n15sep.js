window.WL_I18N = (function(){
  ...
  var CHROME = {
    en:{
      ...
      industries:['MANUFACTURING','HEALTHCARE','ENTERTAINMENT','LOGISTICS','PROPERTY MANAGEMENT','RETAIL','IT SERVICES']
    },
    ru:{
      nav:{overview:'Главная', about:'О нас', accounting:'Бухгалтерские услуги', planning:'Финансовое планирование', contact:'Контакты'},
      cta:'Записаться на консультацию \u2192',
      footHead:'Отрасли, с которыми мы работаем',
      footSub:'Растущий бизнес во всех секторах',
      industries:['ПРОИЗВОДСТВО','ЗДРАВООХРАНЕНИЕ','РАЗВЛЕЧЕНИЯ','ЛОГИСТИКА','УПРАВЛЕНИЕ НЕДВИЖИМОСТЬЮ','РОЗНИЧНАЯ ТОРГОВЛЯ','ИТ-УСЛУГИ']
    },
    es:{
      ...
      industries:['FABRICACIÓN','SALUD','OCIO','LOGÍSTICA','GESTIÓN INMOBILIARIA','COMERCIO MINORISTA','SERVICIOS TI']
    }
  };
  ...
  function RU(IMG, ic, IC){ return {
    overview:{
      ...
      right:'<div class="we-page-home">'+IMG.overview
        ...
        +'<li>Расчёт себестоимости</li><li>Бюджетирование и прогнозирование</li><li>Внедрение новых систем</li><li>Миграция данных и отчётность</li>'
        +'</ul></div></div></div>'
    },
    about:{
    ...
    accounting:{
      left:'<div class="we-eyebrow we-center">Бухгалтерия и Финансовое планирование</div>'
        +'<h2 class="we-h2 we-center">Учёт, отчётность <em>и Финансовое планирование</em></h2>'
