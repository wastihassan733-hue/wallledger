window.WL_I18N = (function(){
  ...
  var CHROME = {
    ...
    ru:{
      ...
      industries:['ПРОИЗВОДСТВО','ЗДРАВООХРАНЕНИЕ','РАЗВЛЕЧЕНИЯ','ЛОГИСТИКА','УПРАВЛЕНИЕ НЕДВИЖИМОСТЬЮ','РОЗНИЧНАЯ ТОРГОВЛЯ','IT УСЛУГИ']
    },
    es:{
      ...
      industries:['FABRICACIÓN','SALUD','OCIO','LOGÍSTICA','GESTIÓN INMOBILIARIA','COMERCIO MINORISTA','IT SERVICIOS']
    }
  };
